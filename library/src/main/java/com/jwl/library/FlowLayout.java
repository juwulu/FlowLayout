...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHorizontalMargin = t.getDimension(R.styleable.FlowLayout_horizontal_margin, 20f);
        mVerticalMargin = t.getDimension(R.styleable.FlowLayout_vertical_margin, 20f);
        t.recycle();
    }
